  ...
  const handleSubmit = async(e) =>{
      ...
      if(data.password === data.confirmPassword){
        ...
        const dataResponse = await fetch(SummaryApi.signUP.url,{
          ...
          if(dataApi.success){
            toast.success(dataApi.message)    //this toast is used for display notification foe creat user , any error
            navigate("/login")       //if user create successfully then navigate to the login page foe that top sec import usenavigation
          }
